...
buttons = {
    ...
    "routes": {
        "main": Ikb(f"{places['map_1']['fullname']} 🏛️", callback_data="map_1"),
        "chem": Ikb(f"{places['map_2']['fullname']}", callback_data="map_2"),
        "mech": Ikb(f"{places['map_3']['fullname']}", callback_data="map_3"),
        "hydro_1": Ikb(f"{places['map_4']['fullname']}", callback_data="map_4"),
        "hydro_2": Ikb(f"{places['map_5']['fullname']}", callback_data="map_5"),
        "nik": Ikb(f"{places['map_6']['fullname']}", callback_data="map_6"),
        "stud_1": Ikb(f"{places['map_7']['fullname']}", callback_data="map_7"),
        "stud_2": Ikb(f"{places['map_8']['fullname']}", callback_data="map_8"),
        "stud_3": Ikb(f"{places['map_9']['fullname']}", callback_data="map_9"),
        "stud_4": Ikb(f"{places['map_10']['fullname']}", callback_data="map_10"),
        "stud_5": Ikb(f"{places['map_11']['fullname']}", callback_data="map_11"),
        "stud_6": Ikb(f"{places['map_12']['fullname']}", callback_data="map_12"),
        "stud_9": Ikb(f"{places['map_13']['fullname']}", callback_data="map_13"),
        "stud_10": Ikb(f"{places['map_14']['fullname']}", callback_data="map_14"),
        "stud_11": Ikb(f"{places['map_15']['fullname']}", callback_data="map_15"),
        "stud_15": Ikb(f"{places['map_16']['fullname']}", callback_data="map_16"),
        "stud_16": Ikb(f"{places['map_17']['fullname']}", callback_data="map_17"),
        "sport": Ikb(f"{places['map_18']['fullname']}", callback_data="map_18"),
        "lab": Ikb(f"{places['map_19']['fullname']}", callback_data="map_19"),
        "hydro_3": Ikb(f"{places['map_20']['fullname']}", callback_data="map_20"),
        "ran": Ikb(f"{places['map_21']['fullname']}", callback_data="map_21"),
        "prof_1": Ikb(f"{places['map_22']['fullname']}", callback_data="map_22"),
        "prof_2": Ikb(f"{places['map_23']['fullname']}", callback_data="map_23"),
        "teach_house": Ikb(f"{places['map_24']['fullname']}", callback_data="map_24"),
        "abit": Ikb(f"{places['map_25']['fullname']}", callback_data="map_25"),
        "ipm": Ikb(f"{places['map_26']['fullname']}", callback_data="map_26"),
    },
    "shedule": {
