# Старт и регистрация
startMessage_1 = (
    "Привет! Я политехник - неофициальный бот Политехнического университета."
...
regMessage_1 = (
    "Чтобы нам было проще общаться, напиши, как тебя зовут (просто напиши своё имя в сообщении "
    "*без лишних символов*)"
)
...
errorMessage_2 = (
    "Я пока не знаю, в какой группе ты обучаешься. "
...
errorMessage_9 = (
    "*Я вижу тут больше, чем одно слово, придумай новое имя и отправь его снова*"
)
errorMessage_10 = (
    "*Произошла ошибка при обновлении расписания или расписание для твоей группы ещё не добавлено."
...
replyMessage_3 = (
    "*Твоё расписание добавлено! Теперь можешь использовать команду /schedule*"
)
...
scheduleMessage_7 = (
    "*Нашлось несколько совпадений, выбери нужного преподавателя из списка*"
)
...
settingsMessage_2 = (
    "Для того, чтобы изменить номер группы, сделай следующее:"
    "\n1. Перейди на сайт https://ruz.spbstu.ru, выбери свой университет и группу"
    "\n2. Скопируй ссылку на эту страницу и отправь её мне"
)
settingsMessage_3 = "В скором времени здесь будет доступна форма для вопросов, а пока по всем вопросам пиши @lrrrtm"
settingsMessage_4 = (
    "Я политехник - неофициальный бот Политехнического университета."
    "\n\nВокруг мессенджеров сейчас строится наибольшая часть взаимодействия между людьми, "
    "поэтому было бы удобно пользоваться всем, не выходя из Телеграмма."
    "\n\nЭтот бот - аналог приложений PolyNavi и подобных, но его отличие в том, что он универсален "
    "абсолютно для всех устройств вне зависимости от их платформы и везде выглядит одинаково. "
