...
errorMessage_8 = "*Ты используешь недопустимые символы, имя должно состоять только из русских букв, придумай новое и отправь его снова*"
...
settingsMessage_4 = "Я политехник - неофициальный бот Политехнического университета." \
                 ...
                 "абсолютно для всех устройств вне зависимости от их платформы и везде выглядит одинаково. " \
                    ...
                    "\n-собачки для снятия морального напряжения (/dogs)"
